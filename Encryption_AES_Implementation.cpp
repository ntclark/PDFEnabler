...
int AESImplementation::init(Mode mode,Direction dir,const UINT8 * key,KeyLength keyLen,UINT8 * initVector)
{
  // Not initialized yet
  m_state = Invalid;
...
int AESImplementation::blockEncrypt(const UINT8 *input,int inputLen,UINT8 *outBuffer)
{
  int i, k, numBlocks;
...
int AESImplementation::padEncrypt(const UINT8 *input, int inputOctets, UINT8 *outBuffer)
{
...
int AESImplementation::blockDecrypt(const UINT8 *input, int inputLen, UINT8 *outBuffer)
{
  int i, k, numBlocks;
  UINT8 block[16], iv[4][4];
...
int AESImplementation::padDecrypt(const UINT8 *input, int inputOctets, UINT8 *outBuffer)
{
  int i, numBlocks, padLen;
  UINT8 block[16];
  UINT32 iv[4];
...
void AESImplementation::keySched(UINT8 key[_MAX_KEY_COLUMNS][4])
{
  int j,rconpointer = 0;
...
void AESImplementation::keyEncToDec()
{
  UINT32 r;
  UINT8 *w;
...
void AESImplementation::encrypt(const UINT8 a[16], UINT8 b[16])
{
  UINT32 r;
  UINT8 temp[4][4];
...
void AESImplementation::decrypt(const UINT8 a[16], UINT8 b[16])
{
  int r;
  UINT8 temp[4][4];
